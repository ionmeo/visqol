...
git_repository(
    ...
    patch_args = ["-p1"],
    patches = ["//:tensorflow_cstdint.patch", "//:tensorflow_win_arm64.patch", "//:tensorflow_win_arm64_copts.patch", "//:farmhash_win_arm64.patch", "//:tensorflow_win_arm64_kernels.patch"],
)
